...
train_set = train_masked_kspace_dataset(train_path, AF=AF, inner_slices=8, rand=True, scale_factor=1e6)
val_set = train_masked_kspace_dataset(val_path, AF=AF, scale_factor=1e6)

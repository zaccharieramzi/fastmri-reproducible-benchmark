...
from feature_multidomain_learning.models.multi_domain_convolution import MultiDomainConv
...
class MWCNNMultiDomain(Model):
    def __init__(
        ...
        super(MWCNNMultiDomain, self).__init__(**kwargs)
